...
"""
    ...
    function get_gp(data::ProfileData, kernel::Kernel, normalize, d)
    ...
    function get_gpr_pred(gp::GP, data::ProfileData)
    ...
    function error_metric_comparison(k::Int64, 𝒟::ProfileData, d, γs, normalize)
    ...
    function me_file_comparison(k::Int64, d, γs, v_str; normalize=true)
        ...
        for file in ["general_strat_8_profiles.jld2","general_strat_16_profiles.jld2","general_strat_32_profiles.jld2"]
            ...
            𝒟 = construct_profile_data(file, v_str, 16; N=4)
    ...
    function get_min_gamma(k::Int64, data::ProfileData, normalize, d, γs)
    ...
    function get_min_gamma_alpha(k::Int64, data::ProfileData, normalize, d, γs)
        # returns the gamma value that minimizes the mean error on the true check
        # only tests the gamma values listed in γs parameter
    ...
    function animate_profile(filename, k::Int64, γ, d, D, V_str; normalize=true)
        ...
        data = construct_profile_data(filename, V_str, D; N=4)
