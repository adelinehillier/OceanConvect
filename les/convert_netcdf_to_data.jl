...
"""
Adapted from sandreza/Learning/sandbox/oceananigans_converter.jl but for netcdf files.
...
struct OceananigansData{𝒮, 𝒯, 𝒰, 𝒱}
    ...
    #bottom boundary condition data, see string for type of boundary condition,4
    bottom_T::𝒰
    bottom_S::𝒰
    bottom_U::𝒰
    bottom_V::𝒰
